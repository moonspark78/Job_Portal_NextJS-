  ...
  return (
    ...
    <div className='pt-20 pb-12'>
        ...
        <div className='w-[80%] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-[4rem] gap-[3rem] items-center'>
          <JobCategoryCard image="/images/icon1.png" category="Fiance" openPosition="23"/>
          ...
          <JobCategoryCard image="/images/icon5.png" category="Humen Resource" openPosition="23"/>
          ...
          <JobCategoryCard image="/images/icon9.png" category="Prject Management" openPosition="23"/>
        </div>
    </div>
  )
}
